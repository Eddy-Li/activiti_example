...
public class VacationBossTaskListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        //获取该员工的经理
        User boss = identityService.createUserQuery().memberOfGroup("G8888").singleResult();
        //设置该经理为经理审批的办理人
        delegateTask.setAssignee(boss.getId());
    }
